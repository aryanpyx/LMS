        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-center gap-2 bg-blue-50 text-blue-700 py-3 px-4 rounded-lg font-medium hover:bg-blue-100 transition-colors">
                  <span className="text-xl">🚀</span> Upgrade Plan
                </button>
                <button className="w-full flex items-center justify-center gap-2 bg-purple-50 text-purple-700 py-3 px-4 rounded-lg font-medium hover:bg-purple-100 transition-colors">
                  <span className="text-xl">📊</span> View Analytics
                </button>
                <button className="w-full flex items-center justify-center gap-2 bg-red-50 text-red-700 py-3 px-4 rounded-lg font-medium hover:bg-red-100 transition-colors">
...
>>>>>>> 2fcd32fb53f3aaca8e9efa8b0de4b804310ac8cd
              </div>
            </div>
          </div>
        </div>
