        ...
        const mockCourses = [
          {
            ...
            enrolled: 2340,
            thumbnail:
              "https://via.placeholder.com/300x200?text=React+Advanced",
            description:
          ...
          },
          {
            ...
            enrolled: 987,
            thumbnail:
              "https://via.placeholder.com/300x200?text=DevOps+Docker+K8s",
            description:
          ...
          },
          {
            ...
            enrolled: 1678,
            thumbnail:
              "https://via.placeholder.com/300x200?text=Flutter+Mobile",
            description:
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover and purchase premium courses to accelerate your learning
            journey
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {subscriptions.map((sub) => (
              <div
                key={sub.id}
                className={`bg-white p-6 rounded-lg shadow-md border-2 ${sub.popular ? "border-indigo-500" : "border-gray-200"}`}
              >
                {sub.popular && (
          ...
          {filteredCourses.map((course) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="w-full bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700 font-semibold">
                  Enroll Now
                </button>
              </div>
            </div>
